#ifndef TauAnalysis_RecoTools_ElectronHistManager_h  
#define TauAnalysis_RecoTools_ElectronHistManager_h
...
#include "TauAnalysis/RecoTools/interface/HistManagerAdapter.h"
