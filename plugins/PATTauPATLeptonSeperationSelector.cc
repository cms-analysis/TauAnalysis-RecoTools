...
// $Id: PATTauPATLeptonSeperationSelector.cc,v 1.1 2009/01/16 13:20:16 kap01 Exp $
//
//

#include "TauAnalysis/RecoTools/plugins/PATTauPATLeptonSeperationSelector.h"
...
DEFINE_ANOTHER_FWK_MODULE(PATTauPATLeptonSeperationSelector);
