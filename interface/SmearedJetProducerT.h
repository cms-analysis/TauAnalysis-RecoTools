#ifndef TauAnalysis_RecoTools_SmearedJetProducerT_h
#define TauAnalysis_RecoTools_SmearedJetProducerT_h
...
//--- configuration parameters
  ...
  double varyByNsigmas_; // option to "smear" jet energy by N standard-deviations, useful for template morphing
};
